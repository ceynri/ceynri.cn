...
Define the automated quality gate that must pass before merging changes — type check, lint, build, and dead link detection — supporting the "AI self-verify, minimal human review" development model.
